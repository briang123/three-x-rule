...
// Utility function to get platform colors
export const getPlatformColors = (platform: string): PlatformColors => {
  const colors = {
    twitter: {
...
// Utility function to get content type label
export const getContentTypeLabel = (postType: string): string => {
  switch (postType) {
    case 'tweet':
      return 'Tweet';
    case 'thread':
